...
const photos = [
  ...
  { src: img1, alt: 'Person 4', caption: 'This is Person 4' },
  { src: img2, alt: 'Person 4', caption: 'This is Person 4' },
...
function People() {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-100 to-gray-300 min-h-screen p-4">
      <h1 className="text-4xl font-extrabold mb-8 text-center text-gray-700">People Images</h1>
