              ...
              <AnimatePresence custom={1} mode="wait">
                ...
                >
                  ...
                  <div className="w-full mt-4 bg-black/50 text-white p-4 rounded-lg">
                    <h3 className="text-xl font-bold">{products[currentImageIndex]?.alt}</h3>
                    <p>{products[currentImageIndex]?.caption}</p>
                    {/* <p className="text-white font-bold mt-2">{products[currentImageIndex]?.price}</p> */}
                  </div>
                </motion.div>
              </AnimatePresence>
